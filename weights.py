class Weights:
    ...
    def update_weights(self):
        self.w_cpra1 = int(self.w_cpra1 + 200 * (1 - (self.ip_cpra1 / self.p_cpra1)))
        if self.w_cpra1 < 2:
            self.w_cpra1 = 2
        self.w_cpra2 = int(self.w_cpra2 + 200 * (1 - (self.ip_cpra2 / self.p_cpra2)))
        if self.w_cpra2 < 2:
            self.w_cpra2 = 2
        self.w_cpra3 = int(self.w_cpra3 + 200 * (1 - (self.ip_cpra3 / self.p_cpra3)))
        if self.w_cpra3 < 2:
            self.w_cpra3 = 2
        self.w_cpra4 = int(self.w_cpra4 + 200 * (1 - (self.ip_cpra4 / self.p_cpra4)))
        if self.w_cpra4 < 2:
            self.w_cpra4 = 2
        self.w_cpra5 = int(self.w_cpra5 + 200 * (1 - (self.ip_cpra5 / self.p_cpra5)))
        if self.w_cpra5 <= 2:
            self.w_cpra5 = 2
        self.print_weights()
